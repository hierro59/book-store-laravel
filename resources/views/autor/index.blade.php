<!DOCTYPE html>
<html lang="en">
<x-head :autor="$autor" :avatar="$avatar" />
                                ...
                                <div
                                    ...
                                    <ul class="flex justify-center lg:justify-start max-md:grid">
                                        @if (isset($facebook))
                                            <li>
                                                <!-- Facebook -->
                                                <a href="{{ $facebook }}" target="_BLANK" data-te-ripple-init
                                        ...
                                        @if (isset($instagram))
                                            <li>
                                                <!-- instagram -->
                                                <a href="{{ $instagram }}" target="_BLANK" data-te-ripple-init
                                                    data-te-ripple-color="light"
                                                    class="mr-4 mb-2 inline-block rounded px-6 py-2.5 text-xs font-medium uppercase leading-normal text-white shadow-md transition duration-150 ease-in-out hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg"
                                        ...
                                        @if (isset($linkedin))
                                            <li>
                                                <!-- linkedin -->
                                                <a href="{{ $linkedin }}" target="_BLANK" data-te-ripple-init
                                                    data-te-ripple-color="light"
                                                    class="mr-4 mb-2 inline-block rounded px-6 py-2.5 text-xs font-medium uppercase leading-normal text-white shadow-md transition duration-150 ease-in-out hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg"
                                        ...
                                        @if (isset($youtube))
                                            <li>
                                                <!-- youtube -->
                                                <a href="{{ $youtube }}" target="_BLANK" data-te-ripple-init
                                                    data-te-ripple-color="light"
                                                    class="mr-4 mb-2 inline-block rounded px-6 py-2.5 text-xs font-medium uppercase leading-normal text-white shadow-md transition duration-150 ease-in-out hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg"
                                        ...
                                        @if (isset($tiktok))
                                            <li>
                                                <!-- tiktok -->
                                                <a href="{{ $tiktok }}" target="_BLANK" data-te-ripple-init
                                                    data-te-ripple-color="light"
                                                    class="mr-4 mb-2 inline-block rounded px-6 py-2.5 text-xs font-medium uppercase leading-normal text-white shadow-md transition duration-150 ease-in-out hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg"
                                        ...
                                        @if (isset($twitter))
                                            <li>
                                                <!-- twitter -->
                                                <a href="{{ $twitter }}" target="_BLANK" data-te-ripple-init
                                                    data-te-ripple-color="light"
                                                    class="mr-4 mb-2 inline-block rounded px-6 py-2.5 text-xs font-medium uppercase leading-normal text-white shadow-md transition duration-150 ease-in-out hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg"
