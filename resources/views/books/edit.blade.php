            ...
            <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                <form method="POST" action="{{ route('books.store') }}" class="p-6" enctype="multipart/form-data">
                    ...
                    <div class="my-4">
                        ...
                        <x-text-input id="year" name="publish_date" value="{{ $book['date'] }}" type="date"
                            class="mt-1 block w-full" required />
                    ...
                    <div class="my-4">
                        ...
                        <x-text-input id="isbn" name="isbn"
                            value="{{ $book['isbn'] == null ? null : $book['isbn'] }}" type="text"
                            class="mt-1 block w-full" />
                    ...
                    @role(['super-admin', 'admin'])
                        <div class="my-4">
                            <label for="price"
                                class="block mb-2 text-xl font-medium text-gray-900 dark:text-white">Precio neto en USD
                                sugerido por el autor</label>
                            ...
                            <x-text-input id="price" name="price" value="{{ $book['price'] }}" type="number"
                                min="0.00" step="0.01" class="mt-1 block w-full" />
                        ...
                        <div class="my-4">
                            ...
                            <x-text-input id="discount" name="discount" value="{{ $book['discount'] }}" type="number"
