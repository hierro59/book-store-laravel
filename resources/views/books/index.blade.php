<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-wrap md:flex-wrap justify-center"> 
            ...
            <div class="p-4">
                <a class="bg-sky-700 px-4 py-2 text-white hover:bg-sky-800 sm:px-8 sm:py-3 rounded-lg mx-8" href="{{ route('books.create') }}"> Create New Book</a>
            </div>
        </div>
    </x-slot>
<div class="py-12">
                          ...
                          <tr
                            ...
                            <td class="whitespace-nowrap px-6 py-4">
                                ...
                                <x-modal name="confirm-user-deletion{{$book['book_id']}}" :show="$errors->userDeletion->isNotEmpty()" focusable>
                                    <form method="post" action="{{ route('books.destroy', $book['book_slug']) }}" class="p-6">
                                        @csrf
                                        @method('delete')
