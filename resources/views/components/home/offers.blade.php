                ...
                <div class="swiper-slide">
                    <div class="tp-card style-2 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="tp-media" style="max-height: 220px; display: flex; justify-content: center; align-items: center;">
                            <a href="{{ route('detail', $book['slug']) }}"><img src="{{ asset('thumbnail/covers/' . $book['portada']) }}" alt=""></a>
                        </div>
                        <div class="tp-info">
                            <h4 class="tp-title"><a href="{{ route('detail', $book['slug']) }}">{{ $book['name'] }}</a></h4>
                            <div class="tp-meta">
                                <ul class="tp-tags">
                                    <li><a href="{{ route('detail', $book['slug']) }}">{{ strtoupper($book['categoria']) }}</a></li>
                                    {{-- <li><a href="books-detail.html">THRILLER</a></li>
                                    <li><a href="books-detail.html">HORROR</a></li> --}}
                                </ul>
                            </div>
                            <p>{{ substr($book['detail'], 0, 80) }}...</p>
                            <div class="">
