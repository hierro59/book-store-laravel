...
<section class="content-inner-1 bg-grey reccomend ">
    <div class="container">
        <div class="section-head text-center">
            ...
            <p>Sumérgete en el fascinante mundo de la literatura independiente y descubre una exclusiva selección de
                libros escritos por autores independientes que desafían las convenciones literarias.</p>
        </div>
        <!-- Swiper -->
