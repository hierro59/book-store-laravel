                                        ...
                                        <div class="accordion" id="accordionExample">
                                                ...
                                                <div id="collapseOne" class="collapse accordion-collapse"
                                                    ...
                                                    <div class="card-body">
                                                        <p>
                                                            ...
                                                            primera es haciendo
                                                            una “Auto Publicación” y la segunda es dejándonos a nosotros
                                                            que
                                                            nosotros
                                                            hagamos todo el trabajo con tu manuscrito por medio de
                                                            nuestros
                                                            Planes Edición
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="collapseTwo" class="collapse accordion-collapse"
                                                    ...
                                                    <div class="card-body">
                                                        <p>
                                                            Auto publicar una obra, es cuando todo el trabajo de edición
                                                            lo
                                                            has hecho tu mismo o contrataste a alguien más para hacerlo.
                                                            En
                                                            este caso, puedes enviarnos tu obra editada para que nuestro
                                                            Consejo Editor la estudie y apruebe; entonces la pondremos
                                                            disponible en nuestro catálogo y así puedas comercializarla
                                                            en
                                            ...
                                            <div class="card">
                                                <div class="card-header" id="headingFour">
                                                    <h3 class="title" data-bs-toggle="collapse"
                                                        ...
                                                        aria-controls="collapseFour"><span>¿Que significa Edición
                                                            TP?</span>
                                                        <span class="icon"><i class="fa fa-angle-left"
                                                                aria-hidden="true"></i></span>
                                                    </h3>
                                                ...
                                                <div id="collapseFour" class="collapse accordion-collapse"
                                                    ...
                                                    style="visibility: visible !important">
                                                    <div class="card-body">
                                                        <p>La Edición TP o Edición de Textos Prohibidos, es cuando
                                                            nosotros
                                                            recibimos tu manuscrito y hacemos todo el trabajo de
                                                            edición,
                                                            corrección, promoción y comercialización. Para conocer más
                                                            sobre
                                                            como optar por una Edición TP, te invitamos a que visites
                                                            esta
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="collapseFive" class="collapse accordion-collapse"
                                                    ...
                                                    style="visibility: visible !important">
                                                    <div class="card-body">
                                                        <p>Optar por una Edición TP es completamente gratuito; solo
                                                            tiene
                                                            que registrate en nuestra página web como autor y enviarnos
                                                            tu
                                                            manuscrito. El Consejo Editor lo revisará y se pondrá en
                                                            contacto contigo para el proceso de edición. Para conocer
                                                            más
                                                            sobre como optar por una Edición TP, te invitamos a que
                                                            visites
                                            ...
                                            <div class="card">
                                                <div class="card-header" id="headingSix">
                                                    <h3 class="title" data-bs-toggle="collapse"
                                                        ...
                                                        aria-controls="collapseSix"><span>¿Cuál es el proceso de
                                                            edición?
                                                        </span> <span class="icon"><i class="fa fa-angle-left"
                                                                aria-hidden="true"></i></span></h3>
                                                </div>
                                                <div id="collapseSix" class="collapse accordion-collapse"
                                                    ...
                                                    <div class="card-body">
                                                        <p>
                                                            El proceso de edición pasa por varias etapas, pero las más
                                                            importantes son las siguientes:
                                                        </p>
                                                        <ul>
                                                            <li class="p-2">
                                                                <h2>1. Consejo Editor.</h2>
                                                                Luego de que envías el manuscrito de tu obra, el Consejo
                                                                Editor
                                                                lo lee y estudia para determinar la viabilidad de su
                                                                publicación. Si el Consejo Editor lo aprueba, entonces
                                                                continua
                                                                su curso cumpliendo las siguiente etapas; de lo
                                                                contrario, el
                                                                Consejo Editor podrías ayudarte a corregir los problemas
                                                                que se
                                                                puedan presentar para que tu obra finalmente sea
                                                                publicada.
                                                            </li>
                                                            <li class="p-2">
                                                                <h2>2. Corrección ortográfica y de estilo.</h2>
                                                                Todas nuestras obras son corregidas por profesionales
                                                                cualificados y en consenso contigo. Serás una parte
                                                                activa de
                                                                todo el proceso.
                                                            </li>
                                                            <li class="p-2">
                                                                <h2>3. Maquetación de la obra.</h2>
                                                                Todas nuestras obras son maquetadas y diseñadas por
                                                                nuestros
                                                                experimentados maquetadores. Todos ellos tienen una
                                                                especial
                                                                sensibilidad a lo gráfico y espacial, pero, sobre todo,
                                                                todos
                                                                son excelentes profesionales y buenas personas.
                                                            </li>
                                                            <li class="p-2">
                                                                <h2>4. Diseño de la portada.</h2>
                                                                Todas las cubiertas de nuestras obras son diseñadas con
                                                                especial
                                                                atención a las exigencias del autor, pero siempre con
                                                                mucha
                                                                sensibilidad y desde el asesoramiento consensuado para
                                                                llegar al
                                                                mejor resultado para el libro.
                                                            </li>
                                                            <li class="p-2">
                                                                <h2>5. Gestiones legales.</h2>
                                                                Te ayudaremos y asesoraremos con respecto a todos lo
                                                                temas
                                                                legales para preparar tu obra desde el inicio hasta el
                                                                momento
                                                                de su lanzamiento.
                                                            </li>
                                                            <li class="p-2">
                                                                <h2>6. Distribución y lanzamiento.</h2>
                                                                Te acompañaremos en el proceso de preparación del
                                                                lanzamiento
                                                                oficial de tu obra. Te ayudaremos a preparar todo el
                                                                material de
                                                                marketing digital que necesites y programaremos un
                                                                evento para
                                                                ese día tan especial de lanzamiento.
                                                            </li>
                                                            <li class="p-2">
                                                                <h2>7. Comercialización.</h2>
                                                                Una vez tu obra sea presentada al mundo y esté
                                                                disponible en
                                                                nuestro catálogo, venderlo es tan simple como compartir
                                                                el link
                                                                de tu obra por las redes sociales y esperar a que las
                                                                ganancias
                                                                crezcan.
                                                            </li>
                                                        </ul>
                                            ...
                                            <div class="card">
                                                <div class="card-header" id="headingSev">
                                                    <h3 class="title" data-bs-toggle="collapse"
                                                        ...
                                                        aria-controls="collapseSev"><span>¿Bajo qué criterios se fija
                                                            el
                                                            PVP de la obra?
                                                        </span> <span class="icon"><i class="fa fa-angle-left"
                                                                aria-hidden="true"></i></span></h3>
                                                ...
                                                <div id="collapseSev" class="collapse accordion-collapse"
                                                    aria-labelledby="headingSev" data-bs-parent="#accordionExample"
                                                    style="visibility: visible !important">
                                                    <div class="card-body">
                                                        <p>Está condicionado por todos los actores que intervienen en el
                                                            proceso de edición y publicación de una obra. En Textos
                                                            Prohibidos, el PVP lo fijan el autor y el Consejo Editor una
                                                            vez
                                                            el libro esté terminado, atendiendo al número de páginas y
                                                            otras
                                            ...
                                            <div class="card">
                                                <div class="card-header" id="headingEight">
                                                    <h3 class="title" data-bs-toggle="collapse"
                                                        ...
                                                        aria-controls="collapseEight"><span>¿Cómo puedo comprar una
                                                            obra?
                                                        </span> <span class="icon"><i class="fa fa-angle-left"
                                                                aria-hidden="true"></i></span></h3>
                                                </div>
                                                <div id="collapseEight" class="collapse accordion-collapse"
                                                    ...
                                                    <div class="card-body">
                                                        <p>Para comprar una obra en Textos Prohibidos, debes registrarte
                                                            ...
                                                            botón de comprar. Esto te llevará directamente a nuestros
                                                            medios
                                            ...
                                            <div class="card">
                                                <div class="card-header" id="headingNine">
                                                    <h3 class="title" data-bs-toggle="collapse"
                                                        ...
                                                        aria-controls="collapseNine"><span>¿Dónde puedo ver las obras
                                                            que
                                                            compré?
                                                        </span> <span class="icon"><i class="fa fa-angle-left"
                                                                aria-hidden="true"></i></span></h3>
                                                ...
                                                <div id="collapseNine" class="collapse accordion-collapse"
                                                    ...
                                                    style="visibility: visible !important">
                                                    <div class="card-body">
                                                        <p>Todos las obras que adquieras en nuestra plataforma, las
                                                            podrás
                                                            descargar las veces que desees con tan solo ingresar a tu
                                                            Librería Digital en el siguiente enlace: Mis Librería
                                                            Digital en
                                                            Textos prohibidos
                                                        </p>
                                                    </div>
                                            ...
                                            <div class="card">
                                                <div class="card-header" id="headingTen">
                                                    <h3 class="title" data-bs-toggle="collapse"
                                                        ...
                                                        aria-controls="collapseTen"><span>¿Cuales son los medios de
                                                            pago
                                                ...
                                                <div id="collapseTen" class="collapse accordion-collapse"
                                                    ...
                                                    style="visibility: visible !important">
                                                    <div class="card-body">
                                                        <p>Por ahora solo puede comprar una obra a través de nuestro
                                                            único
                                                            medio de pago en PayPal. No se te harán cargos adicionales y
                                                            siempre tendrás control sobre los pagos hechos. Nuestro
                                                            único
                                                            medio de pagos es totalmente automatizado y seguro,
                                                            directamente
                                                            desde la plataforma TextosProhibidos.shop y no existen
                                                            gestores
