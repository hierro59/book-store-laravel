                        ...
                        <div class="col-lg-4 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                            <div class="icon-bx-wraper style-1 m-b30 text-center">
                                ...
                                <div class="icon-content">
                                    ...
                                    <p>Compra títulos impresionantes de la forma más segura con lo último en tecnología
                        ...
                        <div class="col-lg-4 col-sm-6 wow fadeInUp" data-wow-delay="0.2s">
                            <div class="icon-bx-wraper style-1 m-b30 text-center">
                                ...
                                <div class="icon-content">
                                    ...
                                    <p>Ediciones de gran calidad y realizadas para satisfacer las necesidades de nuestra
                                        exclusiva audiencia.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
                            <div class="icon-bx-wraper style-1 m-b30 text-center">
                                ...
                                <div class="icon-content">
                                    ...
                                    <p>Únete a nuestra comunidad para tener acceso a los beneficios de ser un autor o
                                        lector <i>Premium</i>.</p>
                                </div>
                            </div>
                        </div>
                    </div>
